...
class TestKeyValueContainer(unittest.TestCase):
    ...
    def test_basic(self):
        dc = KeyValueContainer([('a', ['1']), ('b', ['2', '3'])])
    ...
    def test_str_special_chars(self):
        ...
        self.assertEquals('a=1&u=Ú-ú-Ü-ü', decoded_str)
        
    def test_unicode(self):
        dc = KeyValueContainer([('a', ['1']), ('b', ['2', '3'])])
        udc = unicode(dc)
        
        self.assertEqual(udc, 'a=1&b=2&b=3')
    ...
    def test_get_short_printable_repr_unicode_value(self):
        dc = KeyValueContainer([('a', ['x']), ('b', ['2', '3'])])
        dc.MAX_PRINTABLE = 5
    ...
    def test_get_short_printable_repr_unicode_value_key(self):
        dc = KeyValueContainer([('aéb', ['céd']), ('b', ['2', '3'])])
        dc.MAX_PRINTABLE = 7
